...
Explicación: Primero busque las formulas adecuadas para el perimetro total y el area total, entrable las funciones y luego con los datos agregados por el usuario se opera.
```
import math
